...
import { Edit2, Trash2, Calendar, Clock, Send, FileText, Star, Layout } from 'lucide-react';
...
interface AdminNewsListProps {
    ...
    onHighlight: (item: NewsItem) => void;
}

const AdminNewsList: React.FC<AdminNewsListProps> = ({ items, onDelete, onPublish, onHighlight }) => {
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden animate-in fade-in duration-700">
            <div className="p-6 border-b border-gray-50 flex items-center justify-between bg-gray-50/50">
                ...
                <span className="text-sm font-bold text-gray-500">{items.length} Notícias</span>
            </div>
