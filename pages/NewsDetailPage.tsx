                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-t border-gray-100 pt-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 flex items-center justify-center rounded-full bg-[#1877F2] text-white hover:opacity-90 transition-all shadow-sm hover:scale-110"
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 flex items-center justify-center rounded-full bg-[#25D366] text-white hover:opacity-90 transition-all shadow-sm hover:scale-110"
                ...
                <div className="bg-gray-100 rounded-2xl overflow-hidden mb-12 shadow-lg w-full relative group">
                    ...
                    <div className="bg-gradient-to-t from-black/80 to-transparent absolute bottom-0 left-0 right-0 p-6 pt-12">
                        <p className="text-xs md:text-sm text-white/90 uppercase tracking-widest font-medium">
                            {news.imageDescription || "FOTO: DIVULGAÇÃO / REDAÇÃO"}
                        </p>
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {relatedNews.map(item => (
                            <Link key={item.id} to={`/noticia/${item.slug || item.id}`} className="group flex flex-col gap-3">
